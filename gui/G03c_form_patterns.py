...
#   - G03b_container_patterns → titled sections.
#   - G03c_form_patterns    → form compositions (THIS MODULE).
#
# ----------------------------------------------------------------------------------------------------
...
# 3. TYPE DEFINITIONS
# ----------------------------------------------------------------------------------------------------
# Dataclasses for form field specifications and results.
# ====================================================================================================
...
# ----------------------------------------------------------------------------------------------------
# Individual form field rows with label + input widget.
# ====================================================================================================
...
# ----------------------------------------------------------------------------------------------------
# Error message display with show/hide controls.
# ====================================================================================================
...
# ----------------------------------------------------------------------------------------------------
# Multi-field form builders from specifications.
# ====================================================================================================
...
# ----------------------------------------------------------------------------------------------------
# Action button rows with alignment options.
# ====================================================================================================
...
# ----------------------------------------------------------------------------------------------------
# Expose form patterns for G03+ page builders.
# ====================================================================================================
...
def main() -> None:
    """
    Description:
        Self-test / smoke test for G03c_form_patterns module.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Tests all form pattern functions with visual demonstration.
    """
    ...
    try:
        ...
        row1, entry1, var1 = form_field_entry(main_frame, label="Username", required=True)
        ...
        row2, combo, var2 = form_field_combobox(
            main_frame, label="Country", options=["USA", "UK", "Canada", "Australia"]
        )
        ...
        row3, spin, var3 = form_field_spinbox(main_frame, label="Age", from_=18, to=100)
        ...
        row4, chk, var4 = form_field_checkbox(main_frame, label="Subscribe to newsletter")
        ...
        val_label, show_error, hide_error = validation_message(main_frame)
        ...
        result = form_group(main_frame, fields=fields)
        ...
        section_result = form_section(main_frame, title="Personal Info", fields=section_fields)
