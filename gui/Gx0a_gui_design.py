...
#   - Expose named widget references for controller wiring (Gx0b).
#   - Keep presentation separate from business logic.
#
# Usage:
#   1. Copy this template and rename to your page name (e.g., Gx0a_users_design.py).
...
#   5. Create a matching Gx0b controller to wire event handlers.
#   6. Run via Gx0b (which imports this design).
#
...
APP_SUBTITLE: str = "Application subtitle or description"
...
#
# Available colour presets: "PRIMARY", "SECONDARY", "SUCCESS", "WARNING", "ERROR", "GREY", "WHITE"
...
class TemplatePage(PageProtocol):
    ...
    Description:
        ...
        Business logic and event wiring belong in the matching Gx0b controller.
    ...
    def build_page_header(self, parent: WidgetType) -> None:
        ...
        # The 'actions' frame can hold buttons — wire them in Gx0b controller.
    ...
    def build_row_1(self, parent: WidgetType) -> None:
        ...
        # Example: Button (Gx0b controller wires the command)
        # In Gx0b: self.page.example_btn.configure(command=self._on_example_click)
...
#
# NOTE: For production use, run via the matching Gx0b controller instead,
...
def main() -> None:
    ...
    Notes:
        ...
        - Use Gx0b controller for full functionality.
    """
    logger.info("=" * 60)
