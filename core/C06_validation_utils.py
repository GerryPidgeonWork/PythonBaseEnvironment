...
# ----------------------------------------------------------------------------------------------------
# Provides shared validation and sanity-check utilities for PyBaseEnv.
#
# Purpose:
...
from core.C02_set_file_paths import PROJECT_ROOT, LOGS_DIR, CONFIG_DIR
...
def main() -> None:
    """
    Description:
        Self-test entry point for C06_validation_utils.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates file, directory, DataFrame, and configuration utilities.
    """
    ...
    logger.info("C06_validation_utils self-test completed successfully.")
