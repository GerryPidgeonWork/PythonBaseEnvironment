...
# ----------------------------------------------------------------------------------------------------
# Centralised configuration loader for PyBaseEnv.
#
# Purpose:
...
#   )
#
#   init_logging()             # from C01, recommended before calling initialise_config()
...
from core.C02_set_file_paths import CONFIG_DIR
...
def main() -> None:
    """
    Description:
        Self-test entry point for C04_config_loader.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates configuration loading and lookup.
    """
    ...
    logger.info("C04_config_loader self-test completed successfully.")
