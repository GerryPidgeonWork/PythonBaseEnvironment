...
#
# C02_set_file_paths is a pure core module and must not import GUI packages.
# ----------------------------------------------------------------------------------------------------
from core.C00_set_packages import *
...
# --- Google API / Google Drive Credential Paths -----------------------------------------------------
...
def main() -> None:
    """
    Description:
        Self-test entry point for C02_set_file_paths.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates path constants and utility functions.
    """
    logger.info("C02_set_file_paths self-test started.")
    ...
    logger.info("C02_set_file_paths self-test completed successfully.")
