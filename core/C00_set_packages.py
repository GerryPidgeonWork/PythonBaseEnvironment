...
# (No project imports — C00 is the root of the import hierarchy)
...
from textwrap import dedent                              # Remove common leading whitespace
...
#
# Notes:
#   C00 is unique: its entire purpose is to re-export imports for use via `from core.C00... import *`.
#   Therefore, __all__ must list every symbol intended to be available project-wide.
# ----------------------------------------------------------------------------------------------------
...
__all__ = [
    ...
    "yaml",
    "tqdm",
    # --- Section 5: Selenium / Web automation ---
    "webdriver",
    "By",
    "Keys",
    "Options",
...
#
# Notes:
#   C00 cannot use the project logger (C03) as that would create a circular import.
#   Self-test output uses print() instead.
# ----------------------------------------------------------------------------------------------------

def main() -> None:
    """
    Description:
        Self-test entry point. Validates that all imports succeeded.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Uses print() because C03 logger is not available (circular import).
    """
    print("C00_set_packages self-test initialised.")
    print(f"  Total exports in __all__: {len(__all__)}")
    print(f"  Python version: {sys.version}")
    print(f"  Pandas version: {pd.__version__}")
    print(f"  NumPy version: {np.__version__}")
    print("C00_set_packages self-test complete.")
