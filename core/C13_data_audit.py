...
# C13_data_audit.py
# ----------------------------------------------------------------------------------------------------
# Provides reusable DataFrame comparison and reconciliation tools for PyBaseEnv.
#
# Purpose:
...
#
# Usage:
#   from core.C13_data_audit import (
#       get_missing_rows,
#       compare_dataframes,
...
# --- Row & Column Comparison Utilities ---------------------------------------------------------------
...
def main() -> None:
    """
    Description:
        Self-test entry point for C13_data_audit.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates missing rows, DataFrame comparison, and sum reconciliation.
    """
    logger.info("🔍 Running C13_data_audit self-test...")
    ...
    logger.info("✅ C13_data_audit self-test completed successfully.")
