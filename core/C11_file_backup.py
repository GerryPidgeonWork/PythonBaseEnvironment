...
# C11_file_backup.py
# ----------------------------------------------------------------------------------------------------
# Enhanced Backup Manager for PyBaseEnv.
#
# Purpose:
...
#
# Usage:
#   from core.C11_file_backup import (
#       create_backup,
...
def main() -> None:
    """
    Description:
        Self-test entry point for C11_file_backup.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates backup creation, listing, retention, and restore in a temp directory.
    """
    logger.info("🔍 C11_file_backup self-test started.")
    ...
    logger.info("✅ C11_file_backup self-test completed successfully.")
