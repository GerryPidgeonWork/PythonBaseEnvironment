...
# C20_gui_helpers.py
# ----------------------------------------------------------------------------------------------------
# Provides reusable GUI utilities and visual standards for PyBaseEnv projects.
#
# Purpose:
...
#
# Usage:
#   from core.C20_gui_helpers import show_info, ProgressPopup, run_in_thread
#
# ----------------------------------------------------------------------------------------------------
...
def main() -> None:
    """
    Description:
        Self-test entry point for C20_gui_helpers.
    Args:
        None.
    Returns:
        None.
    Raises:
        None.
    Notes:
        - Validates message popups and progress bar functionality.
    """
    import time

    logger.info("🔍 Running C20_gui_helpers self-test...")
    ...
    root.destroy()
    logger.info("✅ C20_gui_helpers self-test completed successfully.")
